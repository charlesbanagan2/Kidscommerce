...
with app.app_context():
    ...
    if delivery_earnings:
        ...
        for rider_id, email, name, deliveries, total in delivery_earnings:
            print(f"     • {name} ({email})")
            print(f"       Deliveries: {deliveries}, Total: ₱{total}")
    else:
    ...
    if completed_orders:
        ...
        for order_id, status, rider_id, delivery_fee, rider_email, earnings_status in completed_orders:
            ...
            print(f"     {status_icon} Order #{order_id}: {status}, Rider: {rider_email}, Fee: ₱{delivery_fee}, {earnings_status}")
    else:
    ...
    if delivered_orders:
        ...
        for order_id, rider_id, delivery_fee, rider_email in delivered_orders:
            print(f"     • Order #{order_id}: Rider {rider_email}, Fee: ₱{delivery_fee}")
    ...
    print(f"\n  📊 Statistics:")
    print(f"     Total Delivery Earnings: ₱{total_delivery_earnings}")
